                    ...
                    DbContextOptions<OrdersDbContext>>()))
            {
                ...
                if (!context.Customers.Any())
                {
                    context.Customers.AddRange(
                        new Customer(id: "Maria_Silva", name: "Maria Silva", email: "maria.silva@example.com", phoneNumber: "11987654321", "123456"),
                        new Customer(id: "João_Souza", name: "João Souza", email: "joao.souza@example.com", phoneNumber: "21912345678", "123456"),
                        new Customer(id: "Ana_Pereira", name: "Ana Pereira", email: "ana.pereira@example.com", phoneNumber: "31998765432", "123456"),
                        new Customer(id: "Carlos_Oliveira", name: "Carlos Oliveira", email: "carlos.oliveira@example.com", phoneNumber: "41987651234", "123456"),
                        new Customer(id: "Fernanda_Costa", name: "Fernanda Costa", email: "fernanda.costa@example.com", phoneNumber: "51932148765", "123456")
                    );
                }
